...
use Escola\Arquitetura\Dominio\Aluno\AlunoNaoEncontrado;

class RepositorioAlunoPdo extends RepositorioAluno
{
    ...
    private function mapearAluno(array $dadosAluno): Aluno
    {
        ...
        foreach ($telefones as $linha) {
            $aluno->adicionaTelefone($linha['ddd'], $linha['numero_telefone']);
        }
